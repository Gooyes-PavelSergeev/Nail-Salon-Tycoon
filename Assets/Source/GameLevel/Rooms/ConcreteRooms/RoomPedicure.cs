...
{
    public class RoomPedicure : Room
    {
        public override int MaxStaffCount { get => 5; }
        public override int MaxInteriorCount { get => 5; }
        public RoomPedicure(RoomConfig config, RoomContainer container) : base(config, container)
        {

        }

        public override float PurchasePrice { get { return 10000; } }
        ...
        public override void AddStaff()
        {
            ...
            {
                Staff staff = Staff.Instantiate(this, StaffType.Regular, "Pedicurist");
                if (staff.Active)
                {
                    _staffs.Add(staff);
        ...
        internal override void AddLoadedStaff(Data_OwnedRooms.StaffSaveConfig config)
        {
            ...
            Staff staff = Staff.Instantiate(this, StaffType.Regular, "Pedicurist", id, level);
            if (!staff.Active)
